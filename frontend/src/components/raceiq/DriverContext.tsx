...
import { EMPTY, fmtGap } from "@/lib/raceiq/format";
...
function ContextRow({
  ...
  return (
    <div
      className={`grid grid-cols-[auto_auto_minmax(0,1fr)_auto_auto] items-center gap-2 rounded border px-2 py-1.5 text-left ${
